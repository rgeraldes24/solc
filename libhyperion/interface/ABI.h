...
private:
	...
	/// @a _solidityTypes is the list of original Hyperion types where @a _encodingTypes is the list of
	...
	/// @a _solidityType is the original Hyperion type and @a _encodingTypes is the
