...
char const* solidity_license() HYPC_NOEXCEPT;

/// Returns the compiler version.
///
/// The pointer returned must NOT be freed by the caller.
char const* solidity_version() HYPC_NOEXCEPT;
...
char* solidity_alloc(size_t _size) HYPC_NOEXCEPT;
...
void solidity_free(char* _data) HYPC_NOEXCEPT;
...
char* solidity_compile(char const* _input, CStyleReadFileCallback _readCallback, void* _readContext) HYPC_NOEXCEPT;
...
void solidity_reset() HYPC_NOEXCEPT;
