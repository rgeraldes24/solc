...
{
    local repo="https://github.com/hyperion-external-tests/colonyNetwork.git"
    ...
    cd lib
    rm -Rf dappsys
    git clone https://github.com/hyperion-external-tests/dappsys-monolithic.git -b master_080 dappsys
    cd ..
