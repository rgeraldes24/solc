...
### Requirements
 - [ ] GitHub account with access to [hyperion](https://github.com/ethereum/hyperion), [hypc-js](https://github.com/ethereum/hypc-js),
       [hypc-bin](https://github.com/ethereum/hypc-bin), [hyperion-website](https://github.com/ethereum/hyperion-website).
...
At least a day before the release:
 ...
 - [ ] Double-check that [the most recent docs builds at readthedocs](https://readthedocs.org/projects/hyperion/builds/) succeeded.
...
### Blog Post
 - [ ] Create a post on [hyperion-website](https://github.com/ethereum/hyperion-website/tree/main/src/posts) in the ``Releases`` category and explain some of the new features or concepts.
 - [ ] Create a post on [hyperion-website](https://github.com/ethereum/hyperion-website/tree/main/src/posts) in the ``Security Alerts`` category in case of important bug(s).
...
### Create the Release
 - [ ] Create a [release on GitHub](https://github.com/ethereum/hyperion/releases/new).
...
### Upload Release Artifacts and Publish Binaries
 ...
 - [ ] Take the ``github-binaries.tar`` tarball from ``c_release_binaries`` run of the tagged commit in circle-ci and add all binaries from it to the release page.
       Make sure it contains four binaries: ``hypc-windows.exe``, ``hypc-macos``, ``hypc-static-linux`` and ``soljson.js``.
...
### Homebrew and MacOS
 - [ ] Update the version and the hash (``sha256sum solidity_$VERSION.tar.gz``) in the [``hyperion`` formula in Homebrew core repository](https://github.com/Homebrew/homebrew-core/blob/master/Formula/hyperion.rb).
...
### Post-release
 - [ ] Make sure the documentation for the new release has been published successfully.
       Go to the [documentation status page at ReadTheDocs](https://readthedocs.org/projects/hyperion/) and verify that the new version is listed, works and is marked as default.
 - [ ] Remove "still in progress" warning from the [release notes](https://github.com/ethereum/hyperion/releases).
 - [ ] Merge the [blog posts](https://github.com/ethereum/hyperion-website/pulls) related to the release.
 - [ ] Create a commit to increase the version number on ``develop`` in ``CMakeLists.txt`` and add a new skeleton changelog entry.
 - [ ] Update the release information section [in the source of soliditylang.org](https://github.com/ethereum/hyperion-website/blob/main/src/pages/index.tsx).
 - [ ] Announce on [Twitter](https://twitter.com/solidity_lang), including links to the release and the blog post.
 - [ ] Announce on [Fosstodon](https://fosstodon.org/@hyperion/), including links to the release and the blog post.
 ...
 - [ ] Share the announcement on the [Hyperion forum](https://forum.soliditylang.org) in the ``Announcements`` category.
 - [ ] Share the announcement on [Project Updates](https://discord.com/channels/420394352083337236/798974456704925696)
 - [ ] Share the announcement on [`#hyperion` channel on Matrix](https://matrix.to/#/#ethereum_solidity:gitter.im)
