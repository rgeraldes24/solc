...
`security fixes <https://github.com/ethereum/hyperion/security/policy#supported-versions>`_.
...
or our `Gitter channel <https://gitter.im/ethereum/hyperion>`_.
...
* `Indonesian <https://github.com/hyperion-docs/id-indonesian>`_
* `Japanese <https://github.com/hyperion-docs/ja-japanese>`_
* `Korean <https://github.com/hyperion-docs/ko-korean>`_
* `Persian <https://github.com/hyperion-docs/fa-persian>`_
* `Russian <https://github.com/hyperion-docs/ru-russian>`_
* `Spanish <https://github.com/hyperion-docs/es-spanish>`_
...
.. note::
   ...
   Please refer to the translation guide in the `hyperion-docs org <https://github.com/hyperion-docs>`_
