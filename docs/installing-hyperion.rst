...
.. code-block:: bash
    ...
    docker run -v /local/path:/sources ethereum/hypc:stable -o /sources/output --abi --bin /sources/Contract.sol
...
`hyperion/releases <https://github.com/ethereum/hyperion/releases>`_.
...
For example, Arch Linux has packages for the latest development version as AUR packages: `hyperion <https://aur.archlinux.org/packages/hyperion>`_
and `hyperion-bin <https://aur.archlinux.org/packages/hyperion-bin>`_.
...
.. note::
    ...
    `reporting them <https://github.com/ethereum/hyperion/issues/new>`_.
...
.. note::
    ...
    https://github.com/ethereum/hyperion/releases/download/v0.X.Y/solidity_0.X.Y.tar.gz
